...
public interface ContactsGraph {
	...
	/**
	 * Adds a vertex to the graph. If the vertex already exists in the graph, no
	 * changes are made.
	 *
	...
	/**
	 * Toggles SIR state of vertex. If vertex doesn't exist, then a warning to
	 * System.err should be issued.
	 *
	 * @param vertLabel Vertex to add.
	 */
	...
	/**
	 * Deletes an edge from the graph. If the edge doesn't exists in the graph, no
	 * changes are made, but a warning to System.err should be issued.
	 *
	...
	/**
	 * Deletes a vertex from the graph. If the vertex doesn't exists in the graph,
	 * no changes are made, but a warning to System.err should be issued.
	 *
	...
	/**
	 * Returns the set of in-neighbours for a vertex. If vertex doesn't exist, then
	 * a warning to System.err should be issued.
	 *
	 * @param vertLabel Vertex to find the k-hop neighbourhood for.
	 *
	 * @returns An array of all k-hop neighbours of vertex 'vertLabel'. There should
	 *          be no duplicated edges in the returned array.
	 */
